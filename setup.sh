...
HEROKU_TEAM_NAME="cicd-dev"
HEROKU_BASE_APP_NAME="cicd" 

# Name of the Heroku apps you'll use
HEROKU_DEV_APP_NAME="${HEROKU_BASE_APP_NAME}dev$TICKS"
HEROKU_STAGING_APP_NAME="${HEROKU_BASE_APP_NAME}staging$TICKS"
HEROKU_PROD_APP_NAME="${HEROKU_BASE_APP_NAME}prod$TICKS"
